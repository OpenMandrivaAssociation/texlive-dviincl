...
License:	PD
Source0:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/dviincl.r%{version}.tar.xz
Source1:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/dviincl.doc.r%{version}.tar.xz
BuildArch:	noarch
